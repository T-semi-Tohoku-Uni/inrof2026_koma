...
koma::JointManager::JointManager(
    ...
    hand_pose_pub_ = this->create_publisher<geometry_msgs::msg::PoseStamped> (
        "hand_pose",
        10
    );
    ...
    hand_pose_timer_ = this->create_wall_timer(
      50ms,
      std::bind(&koma::JointManager::handPoseCallback, this)
    );
