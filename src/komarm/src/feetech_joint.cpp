...
koma::FeetechJointState::FeetechJointState(int id) { this->id_ = id; }

koma::Serial::Serial(const char * device_name) { serial_fd_ = open_serial(device_name); }

int koma::Serial::open_serial(const char * device_name)
{
...
: Node("joint_manager", options),
  serial_port(this
                ->declare_parameter<std::string>(
                  "port", "platform-fd500000.pcie-pci-0000:01:00.0-usb-0:1.1.1:1.0")
                .c_str())
{
