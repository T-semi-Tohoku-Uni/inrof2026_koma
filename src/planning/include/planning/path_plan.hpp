...
namespace koma {
    ...
    class PathPlanner: public rclcpp::Node {
        ...
        private:
            ...
            void goal_pose_callback(const std::shared_ptr<inrof2026_koma_type::srv::PoseStamped::Request> request, std::shared_ptr<inrof2026_koma_type::srv::PoseStamped::Response> response);
            void waypoint_callback(const std::shared_ptr<inrof2026_koma_type::srv::PoseStamped::Request> request, std::shared_ptr<inrof2026_koma_type::srv::PoseStamped::Response> response);
