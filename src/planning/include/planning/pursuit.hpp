...
namespace koma {
    ...
    class Pursuit: public rclcpp::Node {
        ...
        private:
            ...
            rclcpp_action::CancelResponse handle_cancel(const std::shared_ptr<rclcpp_action::ServerGoalHandle<inrof2026_koma_type::action::Pursuit>> goal_handle);
            void handle_accepted(const std::shared_ptr<rclcpp_action::ServerGoalHandle<inrof2026_koma_type::action::Pursuit>> goal_handle);
            std::shared_ptr<rclcpp_action::ServerGoalHandle<inrof2026_koma_type::action::Pursuit>> goal_handle_;
    };
}